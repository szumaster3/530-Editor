...
public final class PackJAG {
    private static final PackHeadJAG aClass5_43 = new PackHeadJAG();
    ...
    private static void method68(PackHeadJAG class5) {
        ...
        int[] ai2 = null;
        class5.anInt69 = 1;
        if (PackHeadJAG.anIntArray78 == null) PackHeadJAG.anIntArray78 = new int[class5.anInt69 * 100000];
        boolean flag20 = true;
        while (flag20) {
            ...
            class5.aBoolean66 = byte0 != 0;
            if (class5.aBoolean66) System.out.println("PANIC! RANDOMISED BLOCK!");
            class5.anInt71 = 0;
            byte0 = method67(class5);
            ...
            for (int j = 0; j < 16; j++) {
                ...
                class5.aBooleanArray81[j] = byte1 == 1;
            }
            for (int k = 0; k < 256; k++) {
            ...
            for (int l3 = 0; l3 < j4; l3++) {
                ...
                for (int l1 = 0; l1 < i4; l1++) {
                    if (class5.aByteArrayArray87[l3][l1] > i) i = class5.aByteArrayArray87[l3][l1];
            ...
            for (int k5 = ai2[(l7 - ai1[i7])]; k5 != l4; ) {
                ...
                if ((k5 == 0) || (k5 == 1)) {
                    ...
                    for (; j6 > 0; j6--) {
                        ...
                        PackHeadJAG.anIntArray78[i6] = (byte5 & 0xFF);
                    ...
                    class5.anIntArray74[(class5.aByteArray82[(byte6 & 0xFF)] & 0xFF)] += 1;

                    PackHeadJAG.anIntArray78[i6] = (class5.aByteArray82[(byte6 & 0xFF)] & 0xFF);
            ...
            System.arraycopy(class5.anIntArray74, 0, class5.anIntArray76, 1, 256);
            ...
            for (int l2 = 0; l2 < i6; l2++) {
                ...
                class5.anIntArray76[(byte7 & 0xFF)] += 1;

            }

            class5.anInt72 = (PackHeadJAG.anIntArray78[class5.anInt71] >> 8);
            ...
            flag20 = (class5.anInt75 == class5.anInt92 + 1) && (class5.anInt65 == 0);
    ...
    private static void method69(PackHeadJAG class5) {
        ...
        int[] ai = PackHeadJAG.anIntArray78;
    ...
    private static int method74(int i, PackHeadJAG class5) {
        ...
        while (true) {
            ...
            class5.anInt56 -= 1;
            class5.anInt57 += 1;
            if (class5.anInt57 == 0) class5.anInt58 += 1;
        }
        return j;
    }
}