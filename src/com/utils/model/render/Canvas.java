...
import com.utils.model.properties.ModelProperties;
import com.utils.model.properties.PanelProperties;
...
public final class Canvas extends Field {
    ...
    public static void initModel(byte[] data) {
        if (data == null) {
